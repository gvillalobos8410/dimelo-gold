...
# Persistencia de Estado (No se toca)
for k, v in {'p':1, 'n':'', 'l':'', 'sec':'Otros', 'tip':''}.items():
    if k not in st.session_state: st.session_state[k] = v

# --- 2. MAPA DE SECTORES (AMBIENTACIÓN) ---
sectores = {
    'Agro': {'ej': 'Ej: Venta de 10 cargas de café pergamino...', 'img': 'https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?w=800'},
    ...
    'Construccion': {'ej': 'Ej: Remodelación y pintura...', 'img': 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800'},
    'Otros': {'ej': 'Ej: Describe aquí tu servicio...', 'img': 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800'}
}

# --- 3. AMBIENTE DE INTERFAZ (SCROLL FORZADO) ---
...
<style>
    ...
    /* FORZAR SCROLL EN CUALQUIER DISPOSITIVO */
    ...
    .card {{ 
        ...
        line-height: 1.6; font-family: 'Montserrat'; 
    }}
...
# --- 4. PÁGINA 1: LA PROMESA (RESTAURADA) ---
...
# --- 5. PÁGINA 2: ARQUITECTURA (RESTAURADA) ---
