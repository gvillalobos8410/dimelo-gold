...
# --- 3. ESTILO CSS (ESTÉTICA GOLD SUPREME + SCROLL) ---
st.markdown("""
<style>
...
# PÁGINA 2: CONFIGURACIÓN
    ...
    actividad = st.text_input("¿QUÉ HACES EXACTAMENTE?", value=st.session_state.tip, placeholder="Ej: Venta de café...")
    if actividad: st.session_state.tip = actividad

    st.write("---")
    st.write("<b>¿CÓMO TE PRESENTAS?</b>", unsafe_allow_html=True)
    c1, c2 = st.columns(2)
    with c1:
